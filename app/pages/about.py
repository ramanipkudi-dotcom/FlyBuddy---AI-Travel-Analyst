...
def render_about_page():
    ...
    st.markdown(
        ...
        <div class="fb-glass-card">
            ...
            <div style="font-size: 1.25rem; font-weight: 800; color: {THEME['text_primary']}; margin-bottom: 8px;">
                Comprehensive Historical Flight Records
            </div>
            <p style="font-size: 0.92rem; color: {THEME['text_secondary']}; line-height: 1.6; margin-bottom: 12px;">
    ...
    with col1:
        st.markdown(
            ...
            <div class="fb-glass-card" style="height: 100%;">
                ...
                <div style="font-size: 1.15rem; font-weight: 800; color: {THEME['text_primary']}; margin-bottom: 8px;">
                    Dynamic Route Indicators
                </div>
                <p style="font-size: 0.88rem; color: {THEME['text_secondary']}; line-height: 1.55;">
    ...
    st.markdown(
        ...
        <div class="fb-glass-card" style="margin-top: 14px;">
            ...
            <div style="font-size: 1.2rem; font-weight: 800; color: {THEME['text_primary']}; margin-bottom: 8px;">
                Targeted Visual Insights
            </div>
            <p style="font-size: 0.9rem; color: {THEME['text_secondary']}; line-height: 1.55;">
    ...
    st.markdown(
        f"""
        <div style="padding: 14px 18px; border-radius: 12px; background: rgba(15, 23, 42, 0.45); border: 1px solid rgba(255, 255, 255, 0.06); margin-top: 16px; text-align: center;">
            <span style="font-size: 0.82rem; color: {THEME['text_secondary']};">
